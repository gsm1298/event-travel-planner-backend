                        ...
                        if (rows.length > 0) {
                            resolve(
                                rows.map(row => ({
                                    ...
                                    approvedFlight: new Flight(row.approvedFlight, null, row.flight_price, null, null, null, null, null, null, null, null, row.flight_number, row.flight_order_id, null, null),
                                    created: row.created,
